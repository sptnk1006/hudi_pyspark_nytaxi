...
commonConfig = {'className': 'org.apache.hudi',
                ...
                'path': 's3://pd-hudi-demo-curated-bikedata/'}
...
incrementalConfig = {'hoodie.upsert.shuffle.parallelism': 68, 'hoodie.datasource.write.operation': 'upsert',
...
glueContext.write_dynamic_frame.from_options(frame=DynamicFrame.fromDF(updatedDf, glueContext, "updatedDf"),

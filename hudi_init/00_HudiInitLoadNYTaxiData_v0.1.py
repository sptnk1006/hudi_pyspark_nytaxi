...
inputDf = spark.read.schema(yellow_tripdata_schema)\
    .option("header", "true")\
    .csv("s3://nyc-tlc/trip data/yellow_tripdata_{2018}*.csv").withColumn("pk_col", monotonically_increasing_id() + 1)
...
commonConfig = {'className': 'org.apache.hudi',
                ...
                'path': "s3://pd-hudi-demo-curated-nyc-data/"}

unpartitionDataConfig = {
    'hoodie.datasource.hive_sync.partition_extractor_class': 'org.apache.hudi.hive.NonPartitionedExtractor',
    'hoodie.datasource.write.keygenerator.class': 'org.apache.hudi.keygen.NonpartitionedKeyGenerator'}

initLoadConfig = {'hoodie.bulkinsert.shuffle.parallelism': 10, 'hoodie.datasource.write.operation': 'bulk_insert'}
